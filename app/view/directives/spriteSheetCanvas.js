myDirectives.directive('spriteSheetCanvas', ['loaderSvc','Sky', 'Ground', 'Hill', 'Character', function (loaderSvc, Sky, Ground, Hill, Character) {
        "use strict";
        ...
        return {
            ...
            template: '<canvas id="gamecanvas" style="width:100%"></canvas>',
